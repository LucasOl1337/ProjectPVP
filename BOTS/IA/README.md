...
2. Ajuste as configs em `BOTS/IA/config/`.
3. Rode o treinamento:

```bat
BOTS\IA\scripts\run_training.bat
```
...
- **Tempo/steps da rodada**: `BOTS/IA/config/rounds.json` (`max_seconds`, `max_steps`).
- **Gerações**: `BOTS/IA/config/ga.json` (`generations`).
