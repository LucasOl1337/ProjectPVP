...
& $godot --headless --path "$PWD" --scene res://engine/scenes/Main.tscn -- --training --port=20001 --no-watch --time-scale=8.0
...
& $godot --headless --path "$PWD" --scene res://engine/scenes/Main.tscn -- --training --port=20001 --record-path=user://datasets/sessao_01.jsonl
