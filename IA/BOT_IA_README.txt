...
- Regras como `max_kills`, `max_seconds` e `max_steps` são globais e ficam em `IA/config/match_rules.json`.
...
- O modo de treino executa o próprio jogo em Godot headless carregando `res://scenes/Main.tscn`.
