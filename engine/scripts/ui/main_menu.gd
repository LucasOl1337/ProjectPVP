...
func _on_dev_button_pressed() -> void:
	...
	if CharacterSelectionState:
		...
		CharacterSelectionState.set_bot_enabled(1, false)

		CharacterSelectionState.set_bot_enabled(2, false)

		CharacterSelectionState.set_bot_policy(1, "simple")

		CharacterSelectionState.set_bot_policy(2, "simple")

		CharacterSelectionState.set_bot_profile(1, "default")

		CharacterSelectionState.set_bot_profile(2, "default")

		CharacterSelectionState.set_character(1, "storm_dragon")

		CharacterSelectionState.set_character(2, "storm_dragon")
...
func _go_to_character_select() -> void:
	...
	var packed := load("res://engine/scenes/CharacterSelect.tscn")
...
func _go_to_main() -> void:
	...
	var packed := load("res://engine/scenes/Main.tscn")
