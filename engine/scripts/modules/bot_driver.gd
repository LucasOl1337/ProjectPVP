...
const BotActionFrame = preload("res://engine/scripts/modules/bot_action_frame.gd")

const BotObservationBuilder = preload("res://engine/scripts/modules/bot_observation_builder.gd")

const BotPolicyExternal = preload("res://engine/scripts/modules/bot_policy_external.gd")

const BotPolicySimple = preload("res://engine/scripts/modules/bot_policy_simple.gd")
