...
var genetic_genome_path := {
	1: "res://BOTS/profiles/default/best_genome.json",
	2: "res://BOTS/profiles/default/best_genome.json"
}
...
func set_bot_profile(player_id: int, profile_id: String) -> void:
	...
	genetic_genome_path[player_id] = "res://BOTS/profiles/%s/best_genome.json" % profile
...
func get_genetic_genome_path(player_id: int) -> String:
	return String(genetic_genome_path.get(player_id, "res://BOTS/profiles/default/best_genome.json"))
